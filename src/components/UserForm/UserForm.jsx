            ...
            <div className={css["form"]}>
              <div className={css["tabletInput"]}>
                <div className={css['columnName']}>
                  ...
                  required
                />
                <ErrorMessage name="name" component="div" className={css["errorName"]} /></div>

                <div className={css['columnName']}><Field
                  type="email"
                  id="email"
                  name="email"
                  className={`${css["inputBase"]} ${
                ...
                />
                <ErrorMessage name="email" component="div" className={css["error"]} /></div>
              </div>
