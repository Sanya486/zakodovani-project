            ...
            <div className={css['form']}>
                          ...
                          <div className={css['calendar-wrapper']}>
                            <Field
                              ...
                              className={`${css['calendar']} ${
                                errors.calendar && touched.calendar ? css['error'] : ''
                              }`}
                              value={
                                values.calendar ? values.calendar.toLocaleDateString('en-US') : ''
                              }
                            />
                            {CalendarIcon}
                          </div>
              ...
              <div className={css['radioText']}>
                <label className={css['labelText']}>
                  <Field type='radio' name='radioText' className={css['inputRadio']} />
                  Sedentary lifestyle (little or no physical activity)
                </label>
                <label className={css['labelText']}>
                  <Field type='radio' name='radioText' className={css['inputRadio']} value='2' />
                  Light activity (light exercises/sports 1-3 days per week)
                </label>
                <label className={css['labelText']}>
                  <Field type='radio' name='radioText' className={css['inputRadio']} value='3' />
                  Moderately active (moderate exercises/sports 3-5 days per week)
                </label>
                <label className={css['labelText']}>
                  <Field type='radio' name='radioText' className={css['inputRadio']} value='4' />
                  Very active (intense exercises/sports 6-7 days per week)
                </label>
                <label className={css['labelText']}>
                  <Field type='radio' name='radioText' className={css['inputRadio']} value='5' />
